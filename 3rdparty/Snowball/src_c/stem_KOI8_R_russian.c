...
static const struct among a_0[9] = { { 3, s_0_0, -1, 1, 0 }, { 4, s_0_1, 0, 2, 0 },
                                     { 4, s_0_2, 0, 2, 0 },  { 1, s_0_3, -1, 1, 0 },
                                     { 2, s_0_4, 3, 2, 0 },  { 2, s_0_5, 3, 2, 0 },
                                     { 5, s_0_6, -1, 1, 0 }, { 6, s_0_7, 6, 2, 0 },
                                     { 6, s_0_8, 6, 2, 0 } };
...
static const struct among a_1[26] = {
    { 2, s_1_0, -1, 1, 0 },  { 2, s_1_1, -1, 1, 0 },  { 2, s_1_2, -1, 1, 0 },
    { 2, s_1_3, -1, 1, 0 },  { 2, s_1_4, -1, 1, 0 },  { 2, s_1_5, -1, 1, 0 },
    { 2, s_1_6, -1, 1, 0 },  { 2, s_1_7, -1, 1, 0 },  { 2, s_1_8, -1, 1, 0 },
    { 2, s_1_9, -1, 1, 0 },  { 3, s_1_10, -1, 1, 0 }, { 3, s_1_11, -1, 1, 0 },
    { 2, s_1_12, -1, 1, 0 }, { 2, s_1_13, -1, 1, 0 }, { 2, s_1_14, -1, 1, 0 },
    { 2, s_1_15, -1, 1, 0 }, { 2, s_1_16, -1, 1, 0 }, { 2, s_1_17, -1, 1, 0 },
    { 2, s_1_18, -1, 1, 0 }, { 2, s_1_19, -1, 1, 0 }, { 3, s_1_20, -1, 1, 0 },
    { 3, s_1_21, -1, 1, 0 }, { 2, s_1_22, -1, 1, 0 }, { 2, s_1_23, -1, 1, 0 },
    { 3, s_1_24, -1, 1, 0 }, { 3, s_1_25, -1, 1, 0 }
};
...
static const struct among a_2[8] = { { 2, s_2_0, -1, 1, 0 }, { 2, s_2_1, -1, 1, 0 },
                                     { 2, s_2_2, -1, 1, 0 }, { 3, s_2_3, 2, 2, 0 },
                                     { 3, s_2_4, 2, 2, 0 },  { 1, s_2_5, -1, 1, 0 },
                                     { 2, s_2_6, 5, 1, 0 },  { 3, s_2_7, 6, 2, 0 } };
...
static const struct among a_4[46] = {
    { 1, s_4_0, -1, 2, 0 },  { 2, s_4_1, 0, 2, 0 },   { 2, s_4_2, -1, 1, 0 },
    { 3, s_4_3, 2, 2, 0 },   { 3, s_4_4, 2, 2, 0 },   { 2, s_4_5, -1, 1, 0 },
    { 3, s_4_6, 5, 2, 0 },   { 3, s_4_7, -1, 1, 0 },  { 3, s_4_8, -1, 2, 0 },
    { 3, s_4_9, -1, 1, 0 },  { 4, s_4_10, 9, 2, 0 },  { 4, s_4_11, 9, 2, 0 },
    { 2, s_4_12, -1, 1, 0 }, { 3, s_4_13, 12, 2, 0 }, { 3, s_4_14, 12, 2, 0 },
    { 1, s_4_15, -1, 1, 0 }, { 2, s_4_16, 15, 2, 0 }, { 2, s_4_17, 15, 2, 0 },
    { 1, s_4_18, -1, 1, 0 }, { 2, s_4_19, 18, 2, 0 }, { 2, s_4_20, 18, 2, 0 },
    { 2, s_4_21, -1, 1, 0 }, { 2, s_4_22, -1, 2, 0 }, { 2, s_4_23, -1, 2, 0 },
    { 1, s_4_24, -1, 1, 0 }, { 2, s_4_25, 24, 2, 0 }, { 2, s_4_26, -1, 1, 0 },
    { 3, s_4_27, 26, 2, 0 }, { 3, s_4_28, 26, 2, 0 }, { 2, s_4_29, -1, 1, 0 },
    { 3, s_4_30, 29, 2, 0 }, { 3, s_4_31, 29, 1, 0 }, { 2, s_4_32, -1, 1, 0 },
    { 3, s_4_33, 32, 2, 0 }, { 2, s_4_34, -1, 1, 0 }, { 3, s_4_35, 34, 2, 0 },
    { 2, s_4_36, -1, 2, 0 }, { 2, s_4_37, -1, 2, 0 }, { 2, s_4_38, -1, 2, 0 },
    { 2, s_4_39, -1, 1, 0 }, { 3, s_4_40, 39, 2, 0 }, { 3, s_4_41, 39, 2, 0 },
    { 3, s_4_42, -1, 1, 0 }, { 3, s_4_43, -1, 2, 0 }, { 2, s_4_44, -1, 1, 0 },
    { 3, s_4_45, 44, 2, 0 }
};
...
static const struct among a_5[36] = {
    { 1, s_5_0, -1, 1, 0 },  { 2, s_5_1, 0, 1, 0 },   { 2, s_5_2, 0, 1, 0 },
    { 1, s_5_3, -1, 1, 0 },  { 1, s_5_4, -1, 1, 0 },  { 2, s_5_5, 4, 1, 0 },
    { 2, s_5_6, 4, 1, 0 },   { 2, s_5_7, -1, 1, 0 },  { 2, s_5_8, -1, 1, 0 },
    { 3, s_5_9, 8, 1, 0 },   { 1, s_5_10, -1, 1, 0 }, { 2, s_5_11, 10, 1, 0 },
    { 2, s_5_12, 10, 1, 0 }, { 3, s_5_13, 10, 1, 0 }, { 3, s_5_14, 10, 1, 0 },
    { 4, s_5_15, 14, 1, 0 }, { 1, s_5_16, -1, 1, 0 }, { 2, s_5_17, 16, 1, 0 },
    { 3, s_5_18, 17, 1, 0 }, { 2, s_5_19, 16, 1, 0 }, { 2, s_5_20, 16, 1, 0 },
    { 2, s_5_21, -1, 1, 0 }, { 2, s_5_22, -1, 1, 0 }, { 3, s_5_23, 22, 1, 0 },
    { 2, s_5_24, -1, 1, 0 }, { 2, s_5_25, -1, 1, 0 }, { 3, s_5_26, 25, 1, 0 },
    { 1, s_5_27, -1, 1, 0 }, { 1, s_5_28, -1, 1, 0 }, { 2, s_5_29, 28, 1, 0 },
    { 2, s_5_30, 28, 1, 0 }, { 1, s_5_31, -1, 1, 0 }, { 2, s_5_32, -1, 1, 0 },
    { 2, s_5_33, -1, 1, 0 }, { 1, s_5_34, -1, 1, 0 }, { 1, s_5_35, -1, 1, 0 }
};

static const symbol s_6_0[3] = { 0xCF, 0xD3, 0xD4 };
static const symbol s_6_1[4] = { 0xCF, 0xD3, 0xD4, 0xD8 };

static const struct among a_6[2] = { { 3, s_6_0, -1, 1, 0 }, { 4, s_6_1, -1, 1, 0 } };
...
static const struct among a_7[4] = {
    { 4, s_7_0, -1, 1, 0 }, { 1, s_7_1, -1, 2, 0 }, { 1, s_7_2, -1, 3, 0 }, { 3, s_7_3, -1, 1, 0 }
};

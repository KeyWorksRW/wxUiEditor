...
#include "xrc_list_dlg_base.h"

bool XrcListDlgBase::Create(wxWindow* parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString &name)
{
    ...
    // Event handlers
    Bind(wxEVT_BUTTON, &XrcListDlgBase::OnOK, this, wxID_OK);
    Bind(wxEVT_INIT_DIALOG, &XrcListDlgBase::OnInit, this);

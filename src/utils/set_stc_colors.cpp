...
static void SetDarkModeBase(wxStyledTextCtrl* stc, const StcColorTheme& theme)
{
...
static void SetCppColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                         const StcColorTheme& theme)
{
    ...
    stc->StyleSetForeground(wxSTC_C_WORD2, UserPrefs.is_HighContrast() ? theme.clr_functions :
...
static void SetPythonColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                            const StcColorTheme& theme)
{
    if (set_lexer)
    {
...
static void SetRubyColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                          const StcColorTheme& theme)
{
    if (set_lexer)
    {
...
static void SetFortranColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                             const StcColorTheme& theme)
{
    if (set_lexer)
    {
...
static void SetGoColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                        const StcColorTheme& theme)
{
...
static void SetJuliaColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                           const StcColorTheme& theme)
{
    if (set_lexer)
    {
...
static void SetLuaJitColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                            const StcColorTheme& theme)
{
    if (set_lexer)
    {
...
static void SetTypeScriptColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                                const StcColorTheme& theme)
{
...
static void SetXrcColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                         const StcColorTheme& theme)
{
    if (set_lexer)
    {
    ...
    if (UserPrefs.is_DarkMode())
    {
        ...
        stc->StyleSetForeground(wxSTC_H_COMMENT, UserPrefs.is_HighContrast() ? theme.clr_comments :
                                                                               wxColour("#85e085"));
        stc->StyleSetForeground(wxSTC_H_NUMBER, UserPrefs.is_HighContrast() ? theme.clr_numbers :
                                                                              wxColour("#ff6666"));
        stc->StyleSetForeground(wxSTC_H_ENTITY, UserPrefs.is_HighContrast() ? theme.clr_types :
                                                                              wxColour("#ff6666"));
...
static void SetXmlDefaultColors(wxStyledTextCtrl* stc, bool set_lexer, bool add_keywords,
                                const StcColorTheme& theme)
{
    if (set_lexer)
    {

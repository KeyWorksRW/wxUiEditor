// Syntax extension structure definition
// Purpose: Defines hook functions for extending markdown (tables, strikethrough, task lists, etc.)
// Key type: cmark_syntax_extension - function pointers for parsing, rendering custom syntax
// Hook flow: Parser calls try_opening_block/match_inline -> extension creates custom nodes ->
// renderer calls html_render_func Status: Legacy code - uses manual malloc (Phase 1.5 modernization
// candidate) Dependencies: cmark-gfm.hxx, cmark-gfm-extension_api.hxx

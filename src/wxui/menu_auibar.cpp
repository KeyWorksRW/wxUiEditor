...
MenuAuiBar::MenuAuiBar() : wxMenu()
{
    ...
    menu_item_6->SetBitmap(wxue_img::bundle_tool_svg(24, 24));
    ...
    menu_item_9->SetBitmap(wxue_img::bundle_toolseparator_svg(24, 24));
    ...
    menu_item_7->SetBitmap(wxue_img::bundle_slider_svg(24, 24));
    auto* menu_item_8 = Append(gen_wxSpinCtrl, "Add Spin Control", "Add a wxSpinCtrl control", wxITEM_NORMAL);
    menu_item_8->SetBitmap(wxue_img::bundle_spin_ctrl_svg(24, 24));
}

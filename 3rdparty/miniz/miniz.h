/* miniz.c 3.1.2 - public domain deflate/inflate, zlib-subset, ZIP reading/writing/appending, PNG
...
/* Set MINIZ_USE_UNALIGNED_LOADS_AND_STORES only if not set */
    ...
    #if MINIZ_X86_OR_X64_CPU
        /* Set MINIZ_USE_UNALIGNED_LOADS_AND_STORES to 1 on CPU's that permit efficient integer
         * loads and stores from unaligned addresses. */
        #define MINIZ_USE_UNALIGNED_LOADS_AND_STORES 0
...
#define MZ_VER_SUBREVISION 0
    ...
    /* Define MINIZ_NO_ZLIB_COMPATIBLE_NAMES to disable zlib-compatibility if you use zlib in the
     * same project. */

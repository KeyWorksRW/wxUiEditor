...
class BannerWindowGenerator : public BaseGenerator
{
public:
    ...
    ttlib::cstr GetPythonHelpText(Node*) override { return "wx.BannerWindow"; }
    ttlib::cstr GetPythonURL(Node*) override { return "wx.adv.BannerWindow.html"; }
};

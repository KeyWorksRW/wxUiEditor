...
static const struct among a_0[8] = { { 4, s_0_0, -1, 1, 0 }, { 4, s_0_1, -1, 2, 0 },
                                     { 4, s_0_2, -1, 3, 0 }, { 2, s_0_3, -1, 4, 0 },
                                     { 2, s_0_4, -1, 5, 0 }, { 2, s_0_5, -1, 6, 0 },
                                     { 2, s_0_6, -1, 7, 0 }, { 2, s_0_7, -1, 8, 0 } };
...
static const symbol s_1_5[12] = { 0xD7, 0x90, 0xD7, 0x95, 0xD7, 0xA0,
                                  0xD7, 0x98, 0xD7, 0xA2, 0xD7, 0xA8 };
...
static const symbol s_1_9[14] = { 0xD7, 0x90, 0xD7, 0xA0, 0xD7, 0x98, 0xD7,
                                  0xA7, 0xD7, 0xA2, 0xD7, 0x92, 0xD7, 0xA0 };
static const symbol s_1_10[12] = { 0xD7, 0x90, 0xD7, 0xA0, 0xD7, 0x99,
                                   0xD7, 0x93, 0xD7, 0xA2, 0xD7, 0xA8 };
...
static const symbol s_1_16[14] = { 0xD7, 0x90, 0xD7, 0xA8, 0xD7, 0x95, 0xD7,
                                   0xA0, 0xD7, 0x98, 0xD7, 0xA2, 0xD7, 0xA8 };
static const symbol s_1_17[12] = { 0xD7, 0x90, 0xD7, 0xA8, 0xD7, 0x99,
                                   0xD7, 0x91, 0xD7, 0xA2, 0xD7, 0xA8 };
...
static const symbol s_1_34[16] = { 0xD7, 0xA4, 0xD7, 0x95, 0xD7, 0xA0, 0xD7, 0x90,
                                   0xD7, 0xA0, 0xD7, 0x93, 0xD7, 0xA2, 0xD7, 0xA8 };
static const symbol s_1_35[4] = { 0xD7, 0xA6, 0xD7, 0x95 };
static const symbol s_1_36[14] = { 0xD7, 0xA6, 0xD7, 0x95, 0xD7, 0x96, 0xD7,
                                   0x90, 0xD7, 0x9E, 0xD7, 0xA2, 0xD7, 0xA0 };
...
static const struct among a_1[40] = {
    { 10, s_1_0, -1, 1, 0 },  { 8, s_1_1, -1, 1, 0 },   { 8, s_1_2, -1, 1, 0 },
    { 8, s_1_3, -1, 1, 0 },   { 6, s_1_4, -1, 1, 0 },   { 12, s_1_5, -1, 1, 0 },
    { 10, s_1_6, -1, 1, 0 },  { 4, s_1_7, -1, 1, 0 },   { 6, s_1_8, 7, 1, 0 },
    { 14, s_1_9, 8, 1, 0 },   { 12, s_1_10, 7, 1, 0 },  { 4, s_1_11, -1, 1, 0 },
    { 8, s_1_12, 11, 1, 0 },  { 10, s_1_13, -1, 1, 0 }, { 8, s_1_14, -1, 1, 0 },
    { 8, s_1_15, -1, 1, 0 },  { 14, s_1_16, -1, 1, 0 }, { 12, s_1_17, -1, 1, 0 },
    { 8, s_1_18, -1, 1, 0 },  { 8, s_1_19, -1, 1, 0 },  { 8, s_1_20, -1, 1, 0 },
    { 8, s_1_21, -1, 1, 0 },  { 6, s_1_22, -1, 1, 0 },  { 6, s_1_23, -1, 1, 0 },
    { 6, s_1_24, -1, 1, 0 },  { 4, s_1_25, -1, 1, 0 },  { 4, s_1_26, -1, 1, 0 },
    { 8, s_1_27, -1, 1, 0 },  { 6, s_1_28, -1, 1, 0 },  { 6, s_1_29, -1, 1, 0 },
    { 6, s_1_30, -1, 1, 0 },  { 6, s_1_31, -1, 1, 0 },  { 10, s_1_32, 31, 1, 0 },
    { 10, s_1_33, 31, 1, 0 }, { 16, s_1_34, -1, 1, 0 }, { 4, s_1_35, -1, 1, 0 },
    { 14, s_1_36, 35, 1, 0 }, { 10, s_1_37, 35, 1, 0 }, { 10, s_1_38, 35, 1, 0 },
    { 4, s_1_39, -1, 1, 0 }
};
...
static const struct among a_2[4] = { { 6, s_2_0, -1, -1, 0 },
                                     { 6, s_2_1, -1, -1, 0 },
                                     { 6, s_2_2, -1, -1, 0 },
                                     { 6, s_2_3, -1, -1, 0 } };
...
static const symbol s_3_23[12] = { 0xD7, 0xA4, 0xD7, 0x90, 0xD7, 0xA8,
                                   0xD7, 0x9C, 0xD7, 0xB1, 0xD7, 0xA8 };
...
static const struct among a_3[26] = {
    { 8, s_3_0, -1, 9, 0 },   { 6, s_3_1, -1, 10, 0 },   { 8, s_3_2, 1, 7, 0 },
    { 8, s_3_3, 1, 15, 0 },   { 6, s_3_4, -1, 23, 0 },   { 8, s_3_5, -1, 12, 0 },
    { 8, s_3_6, -1, 1, 0 },   { 8, s_3_7, -1, 18, 0 },   { 10, s_3_8, -1, 21, 0 },
    { 10, s_3_9, -1, 20, 0 }, { 6, s_3_10, -1, 22, 0 },  { 8, s_3_11, -1, 16, 0 },
    { 6, s_3_12, -1, 6, 0 },  { 6, s_3_13, -1, 4, 0 },   { 6, s_3_14, -1, 8, 0 },
    { 6, s_3_15, -1, 3, 0 },  { 8, s_3_16, -1, 14, 0 },  { 6, s_3_17, -1, 2, 0 },
    { 8, s_3_18, -1, 25, 0 }, { 6, s_3_19, -1, 5, 0 },   { 8, s_3_20, -1, 13, 0 },
    { 6, s_3_21, -1, 11, 0 }, { 10, s_3_22, -1, 19, 0 }, { 12, s_3_23, -1, 24, 0 },
    { 8, s_3_24, -1, 26, 0 }, { 8, s_3_25, -1, 17, 0 }
};
...
static const symbol s_4_26[12] = { 0xD7, 0xA9, 0xD7, 0x9C, 0xD7, 0x95,
                                   0xD7, 0xA0, 0xD7, 0x92, 0xD7, 0xA0 };
static const symbol s_4_27[12] = { 0xD7, 0xA6, 0xD7, 0xB0, 0xD7, 0x95,
                                   0xD7, 0xA0, 0xD7, 0x92, 0xD7, 0xA0 };
...
static const symbol s_4_43[12] = { 0xD7, 0x92, 0xD7, 0x90, 0xD7, 0xA0,
                                   0xD7, 0x92, 0xD7, 0xA2, 0xD7, 0xA0 };
...
static const symbol s_4_47[12] = { 0xD7, 0xA9, 0xD7, 0x98, 0xD7, 0x90,
                                   0xD7, 0xA0, 0xD7, 0xA2, 0xD7, 0xA0 };
static const symbol s_4_48[12] = { 0xD7, 0x98, 0xD7, 0xA8, 0xD7, 0x95,
                                   0xD7, 0xA0, 0xD7, 0xA7, 0xD7, 0xA0 };
static const symbol s_4_49[14] = { 0xD7, 0xA4, 0xD7, 0x90, 0xD7, 0xA8, 0xD7,
                                   0x9C, 0xD7, 0xB1, 0xD7, 0xA8, 0xD7, 0xA0 };
...
static const struct among a_4[79] = {
    { 6, s_4_0, -1, 1, 0 },    { 6, s_4_1, -1, 1, 0 },    { 2, s_4_2, -1, 1, 0 },
    { 10, s_4_3, 2, 31, 0 },   { 4, s_4_4, 2, 1, 0 },     { 6, s_4_5, 4, 33, 0 },
    { 4, s_4_6, 2, 1, 0 },     { 8, s_4_7, 2, 1, 0 },     { 6, s_4_8, 2, 1, 0 },
    { 6, s_4_9, 2, 1, 0 },     { 8, s_4_10, 9, 1, 0 },    { 6, s_4_11, -1, 1, 0 },
    { 8, s_4_12, 11, 1, 0 },   { 6, s_4_13, -1, 1, 0 },   { 4, s_4_14, -1, 1, 0 },
    { 4, s_4_15, -1, 1, 0 },   { 8, s_4_16, 15, 3, 0 },   { 10, s_4_17, 16, 4, 0 },
    { 2, s_4_18, -1, 1, 0 },   { 10, s_4_19, 18, 14, 0 }, { 8, s_4_20, 18, 15, 0 },
    { 10, s_4_21, 20, 12, 0 }, { 10, s_4_22, 20, 7, 0 },  { 8, s_4_23, 18, 27, 0 },
    { 10, s_4_24, 18, 17, 0 }, { 10, s_4_25, 18, 22, 0 }, { 12, s_4_26, 18, 25, 0 },
    { 12, s_4_27, 18, 24, 0 }, { 8, s_4_28, 18, 26, 0 },  { 10, s_4_29, 18, 20, 0 },
    { 8, s_4_30, 18, 11, 0 },  { 4, s_4_31, 18, 4, 0 },   { 10, s_4_32, 31, 9, 0 },
    { 10, s_4_33, 31, 13, 0 }, { 10, s_4_34, 31, 8, 0 },  { 10, s_4_35, 31, 19, 0 },
    { 6, s_4_36, 31, 1, 0 },   { 8, s_4_37, 36, 1, 0 },   { 6, s_4_38, 31, 1, 0 },
    { 10, s_4_39, 18, 10, 0 }, { 10, s_4_40, 18, 18, 0 }, { 10, s_4_41, 18, 16, 0 },
    { 4, s_4_42, 18, 1, 0 },   { 12, s_4_43, 42, 5, 0 },  { 8, s_4_44, 42, 1, 0 },
    { 10, s_4_45, 42, 6, 0 },  { 10, s_4_46, 42, 1, 0 },  { 12, s_4_47, 42, 29, 0 },
    { 12, s_4_48, 18, 23, 0 }, { 14, s_4_49, 18, 28, 0 }, { 10, s_4_50, 18, 30, 0 },
    { 10, s_4_51, 18, 21, 0 }, { 6, s_4_52, 18, 5, 0 },   { 2, s_4_53, -1, 1, 0 },
    { 4, s_4_54, 53, 4, 0 },   { 6, s_4_55, 54, 1, 0 },   { 4, s_4_56, 53, 1, 0 },
    { 6, s_4_57, 56, 4, 0 },   { 6, s_4_58, 56, 3, 0 },   { 4, s_4_59, 53, 1, 0 },
    { 6, s_4_60, 59, 2, 0 },   { 8, s_4_61, 59, 1, 0 },   { 6, s_4_62, 53, 1, 0 },
    { 10, s_4_63, 62, 1, 0 },  { 2, s_4_64, -1, 1, 0 },   { 4, s_4_65, 64, 4, 0 },
    { 6, s_4_66, 65, 1, 0 },   { 6, s_4_67, 65, 1, 0 },   { 4, s_4_68, 64, -1, 0 },
    { 6, s_4_69, 64, 1, 0 },   { 6, s_4_70, 64, 3, 0 },   { 8, s_4_71, 70, 4, 0 },
    { 4, s_4_72, -1, 1, 0 },   { 6, s_4_73, 72, 4, 0 },   { 8, s_4_74, 73, 1, 0 },
    { 8, s_4_75, 73, 1, 0 },   { 8, s_4_76, 72, 3, 0 },   { 10, s_4_77, 76, 4, 0 },
    { 4, s_4_78, -1, 32, 0 }
};
...
static const struct among a_5[6] = { { 6, s_5_0, -1, 1, 0 }, { 8, s_5_1, -1, 1, 0 },
                                     { 6, s_5_2, -1, 1, 0 }, { 6, s_5_3, -1, 1, 0 },
                                     { 8, s_5_4, 3, 1, 0 },  { 2, s_5_5, -1, 2, 0 } };
...
static const struct among a_6[9] = { { 4, s_6_0, -1, 1, 0 }, { 4, s_6_1, -1, 1, 0 },
                                     { 6, s_6_2, 1, 1, 0 },  { 8, s_6_3, 2, 1, 0 },
                                     { 10, s_6_4, 3, 1, 0 }, { 8, s_6_5, 1, -1, 0 },
                                     { 8, s_6_6, 1, -1, 0 }, { 6, s_6_7, 1, 1, 0 },
                                     { 4, s_6_8, -1, 1, 0 } };
...
static const symbol s_47[] = { 0xD7, 0xA4, 0xD7, 0x90, 0xD7, 0xA8,
                               0xD7, 0x9C, 0xD7, 0x99, 0xD7, 0xA8 };
...
static const symbol s_77[] = { 0xD7, 0xA4, 0xD7, 0x90, 0xD7, 0xA8,
                               0xD7, 0x9C, 0xD7, 0x99, 0xD7, 0xA8 };
    ...
    }
    {
        ...
        while (1)
        {
            ...
            while (1)
            {
                int c9 = z->c;
                z->bra = z->c;
                if (in_grouping_U(z, g_niked, 1456, 1474, 0))
                    goto lab8;
                z->ket = z->c;
                {
                    int ret = slice_del(z);
...
static int r_mark_regions(struct SN_env* z)
{
    ...
    {
        int c11 = z->c;
        if (in_grouping_U(z, g_consonant, 1489, 1520, 0))
            goto lab13;
        if (in_grouping_U(z, g_consonant, 1489, 1520, 0))
            goto lab13;
        if (in_grouping_U(z, g_consonant, 1489, 1520, 0))
    ...
    if (out_grouping_U(z, g_vowel, 1488, 1522, 1) < 0)
        return 0;
    while (1)
    {
        if (in_grouping_U(z, g_vowel, 1488, 1522, 0))
            goto lab14;
        continue;
    lab14:
        break;
...
static int r_standard_suffix(struct SN_env* z)
{
    ...
    }
    {
        ...
        (void) m7;
        z->ket = z->c;
        if (z->c - 1 <= z->lb || z->p[z->c - 1] >> 5 != 4 ||
            !((285474816 >> (z->p[z->c - 1] & 0x1f)) & 1))
            goto lab9;
        ...
        switch (among_var)
        {
            ...
            case 2:
                ...
                if (in_grouping_b_U(z, g_consonant, 1489, 1520, 0))
                    goto lab9;
                {
                    int ret = slice_del(z);
                    if (ret < 0)

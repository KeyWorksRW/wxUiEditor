...
#endif  // _DEBUG
    {
        m_source->writeLine(txt_PHP_CmtBlock, indent::auto_keep_whitespace);
    }

    if (Project.hasValue(prop_php_project_preamble))
    {
        WritePropSourceCode(Project.getProjectNode(), prop_php_project_preamble);
    }

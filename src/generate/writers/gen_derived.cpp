...
inline constexpr const char* txt_DerivedCmtBlock =
R"===(////////////////////////////////////////////////////////////////////////////
...
wxue::string CppCodeGenerator::DetermineDerivedFilePath(Node* form, PANEL_PAGE panel_type,
...
void CppCodeGenerator::GenerateDerivedClassName(wxue::string& derived_name)
{
    ...
    else if (derived_name.empty())
    {
        ...
        (void) base_name.Replace("My", "");
        (void) base_name.Replace("Base", "");
                                                    ...
                                                    PANEL_PAGE panel_type)
{
    ...
    for (auto* event: events)
    {
        ...
        {
            const wxue::string event_class = event->get_EventInfo()->get_event_class();
            const bool close_type_button = IsCloseTypeButton(event);
...
bool CppCodeGenerator::IsCloseTypeButton(NodeEvent* event)
{
...
bool CppCodeGenerator::ShouldSkipContextMenuEvent(NodeEvent* event)
{
                                                       ...
                                                       bool close_type_button)
{
    ...
    const wxue::string name = event->get_EventInfo()->get_name();

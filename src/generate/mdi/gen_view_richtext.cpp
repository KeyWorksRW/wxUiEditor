/////////////////////////////////////////////////////////////////////////////
// Purpose:   wxRichTextCtrl view class
// Author:    Ralph Walden
...
bool RichTextViewGenerator::ConstructionCode(Code& code)
{
    if (code.is_cpp())
    {
...
bool RichTextViewGenerator::GetIncludes(Node* node, std::set<std::string>& set_src,
...
inline constexpr const auto txt_RichTextCtrlViewHdrBlock =
    R"===(
#pragma once
...
bool RichTextViewGenerator::HeaderCode(Code& code)
{
    tt_string_vector lines;

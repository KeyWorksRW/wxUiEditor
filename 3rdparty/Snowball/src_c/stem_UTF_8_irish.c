...
static const struct among a_0[24] = {
    { 2, s_0_0, -1, 1, 0 },   { 2, s_0_1, -1, 4, 0 },  { 3, s_0_2, 1, 2, 0 },
    { 2, s_0_3, -1, 8, 0 },   { 2, s_0_4, -1, 5, 0 },  { 2, s_0_5, -1, 1, 0 },
    { 4, s_0_6, 5, 2, 0 },    { 2, s_0_7, -1, 6, 0 },  { 2, s_0_8, -1, 9, 0 },
    { 2, s_0_9, -1, 2, 0 },   { 2, s_0_10, -1, 5, 0 }, { 2, s_0_11, -1, 7, 0 },
    { 2, s_0_12, -1, 1, 0 },  { 2, s_0_13, -1, 1, 0 }, { 2, s_0_14, -1, 4, 0 },
    { 2, s_0_15, -1, 10, 0 }, { 2, s_0_16, -1, 1, 0 }, { 2, s_0_17, -1, 6, 0 },
    { 2, s_0_18, -1, 7, 0 },  { 2, s_0_19, -1, 8, 0 }, { 2, s_0_20, -1, 3, 0 },
    { 2, s_0_21, -1, 1, 0 },  { 2, s_0_22, -1, 9, 0 }, { 2, s_0_23, -1, 3, 0 }
};
...
static const struct among a_1[16] = { { 7, s_1_0, -1, 1, 0 },  { 8, s_1_1, 0, 1, 0 },
                                      { 3, s_1_2, -1, 2, 0 },  { 4, s_1_3, 2, 2, 0 },
                                      { 3, s_1_4, -1, 1, 0 },  { 4, s_1_5, 4, 1, 0 },
                                      { 3, s_1_6, -1, 1, 0 },  { 4, s_1_7, 6, 1, 0 },
                                      { 3, s_1_8, -1, 1, 0 },  { 4, s_1_9, 8, 1, 0 },
                                      { 3, s_1_10, -1, 1, 0 }, { 4, s_1_11, 10, 1, 0 },
                                      { 6, s_1_12, -1, 1, 0 }, { 7, s_1_13, 12, 1, 0 },
                                      { 4, s_1_14, -1, 2, 0 }, { 5, s_1_15, 14, 2, 0 } };
...
static const symbol s_2_24[14] = { 'g', 'r', 'a', 'f', 'a', 0xC3, 0xAD,
                                   'o', 'c', 'h', 't', 'a', 0xC3, 0xAD };

static const struct among a_2[25] = {
    { 9, s_2_0, -1, 6, 0 },   { 7, s_2_1, -1, 5, 0 },   { 5, s_2_2, -1, 1, 0 },
    { 8, s_2_3, 2, 2, 0 },    { 6, s_2_4, 2, 1, 0 },    { 12, s_2_5, -1, 4, 0 },
    { 5, s_2_6, -1, 5, 0 },   { 3, s_2_7, -1, 1, 0 },   { 4, s_2_8, 7, 1, 0 },
    { 8, s_2_9, 8, 6, 0 },    { 7, s_2_10, 8, 3, 0 },   { 6, s_2_11, 7, 5, 0 },
    { 10, s_2_12, -1, 4, 0 }, { 7, s_2_13, -1, 5, 0 },  { 7, s_2_14, -1, 6, 0 },
    { 8, s_2_15, -1, 1, 0 },  { 9, s_2_16, 15, 1, 0 },  { 6, s_2_17, -1, 3, 0 },
    { 5, s_2_18, -1, 3, 0 },  { 4, s_2_19, -1, 1, 0 },  { 7, s_2_20, 19, 2, 0 },
    { 5, s_2_21, 19, 1, 0 },  { 11, s_2_22, -1, 4, 0 }, { 10, s_2_23, -1, 2, 0 },
    { 14, s_2_24, -1, 4, 0 }
};
...
static const struct among a_3[12] = {
    { 4, s_3_0, -1, 1, 0 }, { 5, s_3_1, 0, 1, 0 },  { 5, s_3_2, -1, 1, 0 },  { 6, s_3_3, 2, 1, 0 },
    { 3, s_3_4, -1, 2, 0 }, { 4, s_3_5, 4, 2, 0 },  { 5, s_3_6, -1, 1, 0 },  { 4, s_3_7, -1, 1, 0 },
    { 4, s_3_8, -1, 2, 0 }, { 3, s_3_9, -1, 2, 0 }, { 4, s_3_10, -1, 2, 0 }, { 3, s_3_11, -1, 2, 0 }
};

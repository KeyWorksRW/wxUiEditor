...
class DirectoryDialogAdapter : public wxPGEditorDialogAdapter
{
public:
...
class DirectoryProperty : public wxStringProperty
{
public:
    DirectoryProperty(const wxString& label, NodeProperty* prop);

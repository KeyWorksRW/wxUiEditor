/////////////////////////////////////////////////////////////////////////////
// Purpose:   Generate Golang code files
// Author:    Ralph Walden
...
inline constexpr const auto txt_GolangCmtBlock =
R"===(///////////////////////////////////////////////////////////////////////////////
...
bool GenerateGolangFiles(GenResults& /* results */, std::vector<tt_string>* /* pClassList */)
{
    return false;
}

void BaseCodeGenerator::GenerateGoLangClass(Node* form_node, PANEL_PAGE panel_type)
{
    Code code(form_node, GEN_LANG_GOLANG);
    ...
    {
        m_source->writeLine(txt_GolangCmtBlock);
    }
    ...
    {
        m_source->writeLine(tt_string() << "const " << iter << " int = " << id_value++);
    }
    ...
    if (m_embedded_images.size())
    {
        ...
        // TODO: [Randalphwa - 07-13-2023] Need to figure out how to handle images in wxGolang.
    }
    ...
    // TODO: [Randalphwa - 07-13-2023] Need to figure out if wxGolang supports persistence

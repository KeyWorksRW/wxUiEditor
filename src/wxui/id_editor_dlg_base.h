...
class IDEditorDlgBase : public wxDialog
{
public:
    IDEditorDlgBase() {}
    IDEditorDlgBase(wxWindow *parent, wxWindowID id = wxID_ANY, const wxString& title = "ID Editor", const wxPoint& pos =
...
protected:
    ...
    virtual void OnAffirmative(wxUpdateUIEvent& event) { event.Skip(); }
    virtual void OnComboSelect(wxCommandEvent& event) { event.Skip(); }
    virtual void OnCustomID(wxCommandEvent& event) { event.Skip(); }
    virtual void OnInit(wxInitDialogEvent& event) { event.Skip(); }
    virtual void OnStandardID(wxCommandEvent& event) { event.Skip(); }
    virtual void OnStdChange(wxCommandEvent& event) { event.Skip(); }

...
static const struct among a_0[10] = { { 2, s_0_0, -1, 1, 0 }, { 3, s_0_1, -1, 2, 0 },
                                      { 4, s_0_2, -1, 1, 0 }, { 3, s_0_3, -1, 1, 0 },
                                      { 3, s_0_4, -1, 1, 0 }, { 4, s_0_5, -1, 1, 0 },
                                      { 6, s_0_6, -1, 1, 0 }, { 2, s_0_7, -1, 1, 0 },
...
static const struct among a_1[6] = { { 3, s_1_0, -1, -1, 0 }, { 2, s_1_1, -1, -1, 0 },
                                     { 3, s_1_2, -1, -1, 0 }, { 2, s_1_3, -1, -1, 0 },
                                     { 3, s_1_4, 3, -1, 0 },  { 3, s_1_5, 3, -1, 0 } };
...
static const struct among a_2[6] = { { 4, s_2_0, -1, -1, 0 }, { 3, s_2_1, -1, -1, 0 },
                                     { 4, s_2_2, -1, -1, 0 }, { 3, s_2_3, -1, -1, 0 },
                                     { 4, s_2_4, 3, -1, 0 },  { 4, s_2_5, 3, -1, 0 } };

static const symbol s_3_0[3] = { 'l', 'l', 'e' };
static const symbol s_3_1[3] = { 'i', 'n', 'e' };

static const struct among a_3[2] = { { 3, s_3_0, -1, -1, 0 }, { 3, s_3_1, -1, -1, 0 } };
...
static const struct among a_4[9] = { { 3, s_4_0, -1, 3, 0 }, { 3, s_4_1, -1, 3, 0 },
                                     { 3, s_4_2, -1, 3, 0 }, { 2, s_4_3, -1, 2, 0 },
                                     { 2, s_4_4, -1, 1, 0 }, { 2, s_4_5, -1, 4, 0 },
                                     { 2, s_4_6, -1, 6, 0 }, { 3, s_4_7, -1, 5, 0 },
                                     { 4, s_4_8, -1, 3, 0 } };
...
static const struct among a_5[7] = { { 2, s_5_0, -1, -1, 0 }, { 2, s_5_1, -1, -1, 0 },
                                     { 2, s_5_2, -1, -1, 0 }, { 2, s_5_3, -1, -1, 0 },
                                     { 2, s_5_4, -1, -1, 0 }, { 4, s_5_5, -1, -1, 0 },
                                     { 4, s_5_6, -1, -1, 0 } };
...
static const struct among a_6[30] = {
    { 1, s_6_0, -1, 8, 0 },      { 3, s_6_1, 0, -1, 0 },      { 2, s_6_2, 0, -1, 0 },
    { 3, s_6_3, 0, -1, 0 },      { 2, s_6_4, 0, -1, 0 },      { 3, s_6_5, 4, -1, 0 },
    { 3, s_6_6, 4, -1, 0 },      { 3, s_6_7, 4, 2, 0 },       { 3, s_6_8, -1, -1, 0 },
    { 3, s_6_9, -1, -1, 0 },     { 3, s_6_10, -1, -1, 0 },    { 1, s_6_11, -1, 7, 0 },
    { 3, s_6_12, 11, 1, 0 },     { 3, s_6_13, 11, -1, r_VI }, { 4, s_6_14, 11, -1, r_LONG },
    { 3, s_6_15, 11, 2, 0 },     { 4, s_6_16, 11, -1, r_VI }, { 3, s_6_17, 11, 3, 0 },
    { 4, s_6_18, 11, -1, r_VI }, { 3, s_6_19, 11, 4, 0 },     { 4, s_6_20, 11, 5, 0 },
    { 4, s_6_21, 11, 6, 0 },     { 2, s_6_22, -1, 8, 0 },     { 4, s_6_23, 22, -1, 0 },
    { 3, s_6_24, 22, -1, 0 },    { 4, s_6_25, 22, -1, 0 },    { 3, s_6_26, 22, -1, 0 },
    { 4, s_6_27, 26, -1, 0 },    { 4, s_6_28, 26, -1, 0 },    { 4, s_6_29, 26, 2, 0 }
};
...
static const struct among a_7[14] = { { 3, s_7_0, -1, -1, 0 }, { 3, s_7_1, -1, 1, 0 },
                                      { 4, s_7_2, 1, -1, 0 },  { 3, s_7_3, -1, 1, 0 },
                                      { 4, s_7_4, 3, -1, 0 },  { 3, s_7_5, -1, 1, 0 },
                                      { 4, s_7_6, 5, -1, 0 },  { 3, s_7_7, -1, 1, 0 },
                                      { 4, s_7_8, 7, -1, 0 },  { 4, s_7_9, -1, -1, 0 },
                                      { 4, s_7_10, -1, 1, 0 }, { 5, s_7_11, 10, -1, 0 },
                                      { 4, s_7_12, -1, 1, 0 }, { 5, s_7_13, 12, -1, 0 } };

static const symbol s_8_0[1] = { 'i' };
static const symbol s_8_1[1] = { 'j' };

static const struct among a_8[2] = { { 1, s_8_0, -1, -1, 0 }, { 1, s_8_1, -1, -1, 0 } };

static const symbol s_9_0[3] = { 'm', 'm', 'a' };
static const symbol s_9_1[4] = { 'i', 'm', 'm', 'a' };

static const struct among a_9[2] = { { 3, s_9_0, -1, 1, 0 }, { 4, s_9_1, 0, -1, 0 } };

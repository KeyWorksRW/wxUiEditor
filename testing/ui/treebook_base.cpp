	...
	wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_treebook->AddPage(page, wxString::FromUTF8("English"), false, 0);
    ...
    m_treebook->AddPage(page_2, wxString::FromUTF8("Français"), false, 1);
    ...
    m_treebook->AddPage(page_3, wxString::FromUTF8("日本語"), false, 2);

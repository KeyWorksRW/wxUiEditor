...
#include "new_propsheet.h"

bool NewPropSheet::Create(wxWindow* parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString &name)
{
    ...
    auto* staticText_3 = new wxStaticText(this, wxID_ANY,
        "These are initial values -- all of them can be changed after the property sheet is created.");
    ...
    m_classname = new wxTextCtrl(this, wxID_ANY, "MySettingsBase");
    ...
    m_textCtrl_title->SetHint("Text for property sheet\'s Title Bar");
    ...
    auto* staticText_4 = new wxStaticText(this, wxID_ANY, "Page&s:");
    ...
    // Event handlers
    Bind(wxEVT_INIT_DIALOG, &NewPropSheet::OnInit, this);
